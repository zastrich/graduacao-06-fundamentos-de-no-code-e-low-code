...
Trabalho apresentado à disciplina Fundamentos de No-code e Low-code, como requisito parcial de avaliação da disciplina.
...
[**Análise e Discussão	4**](#análise-e-discussão)

[Contextualização do Desafio	4](#contextualização-do-desafio)

[Justificativa pelo Uso de No-Code/Low-Code	4](#justificativa-pelo-uso-de-no-code/low-code)

[Modelagem de Dados	4](#modelagem-de-dados)

[Lógica e Workflows	5](#lógica-e-workflows)

[Publicação e Manutenção	5](#publicação-e-manutenção)
...
## Justificativa pelo Uso de No-Code/Low-Code {#justificativa-pelo-uso-de-no-code/low-code}
...
## Lógica e Workflows {#lógica-e-workflows}
...
[https://github.com/zastrich/graduacao-06-fundamentos-de-no-code-e-low-code](https://github.com/zastrich/graduacao-06-fundamentos-de-no-code-e-low-code) 

Vídeo de Apresentação:  
[https://youtu.be/-DsExJu9A5U](https://youtu.be/-DsExJu9A5U) 

Link da demonstração:  
[https://teamflow-27948.bubbleapps.io/version-test/](https://teamflow-27948.bubbleapps.io/version-test/) 